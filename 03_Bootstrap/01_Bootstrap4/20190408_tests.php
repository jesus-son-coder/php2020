...
<body>
<div class="container">
    <h1 class="display-3 mt-4 learning-heading-top-container-1"><strong>Le "Display Heading" avec Bootstrap 4</strong>
    </h1>
    ...
    <div class="card bg-light col-md-12 mt-4">
        <p>
            Le Display heading propose une alternance de 4 tailles allant de display-4 (la plus haute) à display-1 (la
            plus basse).
        </p>
...
<script src="../../00_Librairies/01_01_Bootstrap_4/js/popper.js"></script>
</body>
</html>